...
- 校園／學校／大學／校區內的無障礙設施 → findCampusAccessibility；若已拿到 branchId 且使用者要完整設施清單／某校區詳情 → getCampusAccessibilityDetails
...
「台大校園有哪些無障礙電梯」→ findCampusAccessibility(query="台大", facType="無障礙電梯")
